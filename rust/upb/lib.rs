...
mod message;
pub use message::{deep_clone, MessagePtr, RawMessage};
...
// When building in Bazel `sys` is a separate crate; in Cargo it is a module.
#[cfg(bzl)]
extern crate sys;
#[cfg(not(bzl))]
#[path = "sys/lib.rs"]
...
pub use sys::arena::{upb_Arena, RawArena};
pub use sys::array::{
...
pub use sys::ctype::CType;
pub use sys::extension_registry::{upb_ExtensionRegistry, RawExtensionRegistry};
pub use sys::map::{
...
pub use sys::message_value::{upb_MessageValue, upb_MutableMessageValue};
pub use sys::mini_table::{
...
pub use sys::string_view::StringView;
